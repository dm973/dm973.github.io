...
\indent Theoretical Division, Los Alamos National Laboratory \hfill  \url{https://dm973.github.io} \\
...
\begin{enumerate}[label={[\arabic*]}]
\itemsep0em 
\item (2024) Director's Postdoctoral Fellowship \hfill Los Alamos National Labs 
\item (2024) MSPRF (Declined)\hfill NSF 
\item (2023) 10th Heidelberg Laureate Forum Young Researcher \hfill HLFF 
\item (2022) Graduate Student Travel Award (MDS22) \hfill SIAM 
\item (2019) Special Entrance Scholarship \hfill UCB 
\item (2019) MSc Thesis Certificate with Distinction \hfill SFU 
\end{enumerate}
