...
& Aug. 2017 - July 2019 & \textbf{MSc} Applied Mathematics & Simon Fraser University (SFU)\\ 
& Sept. 2011 - May 2015  & \textbf{BSc} Mathematics, \textbf{BA} Physics & University of Puget Sound (UPS)\\
\end{tabular}

\headr{Research Interests}

\begin{tabular}{@{} p{0.01cm} @{} p{16.5cm}@{} }
 & Model selection and parameter estimation from data, in particular weak-form algorithms, with application to collective dynamics (e.g.\ cell migration, financial markets, autonomous robots, plasma physics).
\end{tabular}
